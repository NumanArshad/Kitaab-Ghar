...
const CustomDrawerContent = (props) => (
  <View style={{ flex: 1 }}>
    <View style={{ flex: 0.25, marginTop: 30, width: "100%", height: "100%" }}>
      <ImageBackground
    ...
    <View style={{ flex: 0.75, marginTop: -30 }}>
      <DrawerContentScrollView>
        ...
        <DrawerItem
          label="Books"
          icon={(props) => <FontAwesome5 name="book" size="10px" {...props} />}
        ...
        <DrawerItem
          label="Settings"
          onPress={() =>
            props.navigation.navigate("MyCart", { screen: "MyCart" })
          }
          icon={(props) => <AntDesign name="setting" size="10px" {...props} />}
